const en = {
  ...
  tripDetail: {
    ...
    deleteDescription: "“{{name}}” and its related bookings will be permanently removed.",
    leave: "Leave Trip",
    ...
    routeHelper: "Keep up to five non-overlapping stops inside the Trip dates.",
    routeInvalid: "Check the stop order and arrival/departure dates.",
  ...
  travelPlan: {
    ...
    workspace: {
      ...
      quickSteps: [
        { title: "Where is this Trip going?", hint: "Name the journey and pick a suggested destination if you already have one in mind." },
        { title: "When do you want to go?", hint: "Choose an approximate date range. You can update it later." },
        { title: "Review your Trip", hint: "Add an optional note, then create the Trip and continue planning." },
      ],
